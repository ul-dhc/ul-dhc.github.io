...
const STR = {
  en:{
    ...
    moves:'Moves',
    winFlag:'Well done! These are some of the fields we work in –<br>researching, experimenting, and collaborating.',
  ...
  lv:{
    ...
    moves:'Gājieni',
    winFlag:'Lieliski! Šīs ir dažas no jomām, kurās mēs darbojamies –<br>pētot, eksperimentējot un sadarbojoties.',
